...
public class GestureTestListener : MonoBehaviour, KinectGestures.GestureListenerInterface
{
    ...
    // singleton instance of the classs
    private static GestureTestListener instance = null;
    ...
    public static GestureTestListener Instance
    {
        get
        {
            return instance;
